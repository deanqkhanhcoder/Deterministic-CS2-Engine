...
// ── 1. DEBUG_FORENSIC ──
#if defined(MARCO_DEBUG_FORENSIC)
    ...
    #define MARCO_ENABLE_TELEMETRY 1
    #define MARCO_ENABLE_HEAVY_TELEMETRY 1
...
// ── 2. PROFILE ──
    ...
    #define MARCO_ENABLE_TELEMETRY 1
    #define MARCO_ENABLE_HEAVY_TELEMETRY 0
...
// ── 3. RELEASE ──
    ...
    #define MARCO_ENABLE_DIAGNOSTICS 0
    #define MARCO_ENABLE_UI_OVERLAY 0
    #define MARCO_ENABLE_TELEMETRY 0
    #define MARCO_ENABLE_HEAVY_TELEMETRY 0
    #define MARCO_ENABLE_LOGGING 0
    #define MARCO_ENABLE_ASSERTS 0
    #define MARCO_ENABLE_UI 1
